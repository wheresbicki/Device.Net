...
namespace Usb.Net.Windows
{
    public static partial class WinUsbApiCalls
    {
        ...
        [DllImport("winusb.dll", SetLastError = true)]
        public static extern bool WinUsb_GetDescriptor(IntPtr InterfaceHandle, byte DescriptorType, byte Index, UInt16 LanguageID, byte[] Buffer, UInt32 BufferLength, out UInt32 LengthTransfered);
        ...
        public static string GetDescriptor(IntPtr defaultInterfaceHandle, byte index, string errorMessage)
        {
